...
- [x] **P2 — Studio-as-surface.** Dockview workspace + projects table (old 4.6 Workstream A). Panels now include Run + Board, not just artifacts. *(implemented 2026-05-18, branch `feat/faro-p2-studio-as-surface`; all 16 plan tasks; L1–L3 + L5 green on the laptop, L4 pei live test pending)*
